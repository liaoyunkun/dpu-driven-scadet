    ...
    #else
    {
        ...
        if (hit_set == 1) {
            ...
            if (ts_diff < INTRA_GROUP_TH) {
                #ifndef __SYNTHESIS__
                std::cout << "ts_diff < INTRA_GROUP_TH" << std::endl;
                #endif
                ...
                if (!tag_hit && uni_tags == WAYS_NUM) {
                    ...
                    if (!dqpn_hit && evict_cnt == 1) {
                        ...
                        #ifndef __SYNTHESIS__
                        std::cout << "dpqn_hit && evict_cnt == 1" << std::endl;
                        #endif
                    ...
                    #ifndef __SYNTHESIS__
                    std::cout << "tags_evict_idx = " << tags_evict_idx << ";";
                    std::cout << "tags_evict_idy = " << tags_evict_idy << std::endl;
                    #endif
                    #endif
